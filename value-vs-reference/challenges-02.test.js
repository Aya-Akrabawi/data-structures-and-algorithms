...
Write a function named raisedToTheThird that takes in an array of numbers and returns a new array of each 
of those numbers raised to the 3rd power (hint: look up Math.pow()). Use forEach to solve this problem.
...
const raisedToTheThird = (arr) => {
  ...
  let raisedNumber ;
  arr.forEach(element => {
      raisedNumber =  Math.pow(element , 3)
      raisedArr.push(raisedNumber)
  });
  return raisedArr
}
...
Write a function that accepts an array of people objects and adds a new property called isAuthor to each object in
 the list. Set the value of the new property to true.
