...
Write a function named templatingWithMustache that uses mustache to create the markup templates for each of the characters.
 Use the snippet as your guide for creating your templates. Return an array of template strings. Note: this function 
 does not need to actually append the markup to the DOM.
...
const templatingWithMustache = () => {
  ...
  Object.keys(characters).forEach(element => {
    characterArr.push(Mustache.render(template, characters[element]));
  });
  return characterArr;
};
